...
declare type CreateVisualElement<Instance> = (isStatic: boolean, options: VisualElementOptions<Instance>) => VisualElement<Instance>;
...
declare type RenderComponent<Instance, RenderState> = (props: MotionProps, ref: React.Ref<Instance>, visualState: VisualState<Instance, RenderState>, isStatic: boolean) => any;
