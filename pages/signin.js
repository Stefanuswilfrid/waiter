...
function SignIn(){
    ...
    return ( 
        ...
        <div className="signin-main" >
            ...
            <img className="connect-img" src="./connect.png" alt="" height="300px"/>
            </div>
        </div>
        </>
    )
...
function ChooseServices(){
    return (
        ...
        <ServiceCard title={'Generate Warm Email Template '} href={"/email"} image={'/writting.png'}/>
        <ServiceCard title={'Have A Chat With Our AI '} href={"/chat"} image={"/v-meet.png"}/>
        <ServiceCard title={'Generate Image From Text Description'} href={"/image"} image={'/paint.png'}/>
